...
var _properRipple = __webpack_require__(7);

var Ripple = _interopRequireWildcard(_properRipple);

var _animatedScrollto = __webpack_require__(14);
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var scrollToLinks = getElements('.scroll-to');
    var workSlides = getElements('.work');
    ...
    scrollToLinks.forEach(function (link) {
        link.addEventListener('click', function () {
            var scrollToID = link.getAttribute('data-scroll-to');
            var element = document.querySelector('#' + scrollToID);
            var scrollTop = element.getBoundingClientRect().top - document.body.getBoundingClientRect().top + offsetDefects[scrollToID];
            (0, _animatedScrollto2.default)(document.body, scrollTop, 700);
            (0, _animatedScrollto2.default)(document.documentElement, scrollTop, 700);
        });
    });

    workSlides.forEach(function (workSlide) {
        var sourceURL = workSlide.getAttribute('data-source');
    ...
    var commonSliderConfig = {
        infinite: true,
        slidesToScroll: 3
    };

    (0, _jquery2.default)('#works-wrapper').slick({
        dots: true,
        slidesToScroll: 1,
        slidesToShow: 3,
        infinite: false
    ...
    (0, _jquery2.default)('#reviews').slick(_extends({
        slidesToShow: 3
    }, commonSliderConfig));

    (0, _jquery2.default)('#clients').slick(_extends({
        slidesToShow: 5
    }, commonSliderConfig));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_api__ = __webpack_require__(8);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__binders__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__defaults__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utility__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ripple_css__ = __webpack_require__(11);
...
// module
exports.push([module.i, ".transition {\n  transition: all 0.2s ease-out;\n}\n.centered {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n}\n.centered-vertically-inside {\n  display: flex;\n  flex-direction: row;\n  justify-content: center;\n}\n.centered-inside-col {\n  text-align: center;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n.centered-inside-row {\n  text-align: center;\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n}\n.block-shadow {\n  box-shadow: 0px 30px 60px -30px rgba(0, 0, 0, 0.45);\n}\n.page-block {\n  position: relative;\n  width: 100%;\n}\n/**************\n****Globals****\n**************/\n/*************\n**** Text ****\n*************/\n/**************\n*** Buttons ***\n**************/\n/*************\n*** Blocks ***\n*************/\na {\n  text-decoration: none;\n}\nbutton,\n.btn {\n  cursor: pointer;\n  min-width: 120px;\n  padding: 10px 12px;\n  border-radius: 2px;\n  border: none;\n  outline: none;\n  background-color: rgba(255, 255, 255, 0.95);\n  text-transform: uppercase;\n  font-size: 15px;\n  font-weight: bold;\n  color: #333436;\n}\nbutton:hover,\n.btn:hover {\n  outline: none;\n  background-color: #fff;\n}\nbutton.large,\n.btn.large {\n  width: 220px;\n  padding: 16px 12px;\n  font-size: 15px;\n}\nbutton.shadow,\n.btn.shadow {\n  box-shadow: 0 8px 30px -6px rgba(0, 0, 0, 0.6);\n}\nbutton.shadow:hover,\n.btn.shadow:hover {\n  box-shadow: 0 12px 30px -6px rgba(0, 0, 0, 0.7);\n}\nbutton.blue,\n.btn.blue {\n  background-color: #0060E3;\n  color: #fff;\n}\nhtml,\nbody {\n  margin: 0;\n  padding: 0;\n}\n.social-links {\n  list-style: none;\n}\n.social-links .social-link {\n  display: inline-block;\n}\n.social-links .social-link:not(:first-child) {\n  margin-left: 15px;\n}\n.social-links .social-link .image {\n  width: 27px;\n  height: 27px;\n  background-size: 100%;\n}\n.social-links .social-link.vk .image {\n  background-image: url('images/social/vk.png');\n  background-repeat: none;\n}\n.social-links .social-link.fb .image {\n  background-image: url('images/social/facebook.png');\n  background-repeat: none;\n}\n.social-links .social-link.be .image {\n  background-image: url('images/social/behance.png');\n  background-repeat: none;\n}\n#container {\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  position: relative;\n  font-family: 'Arimo', sans-serif;\n}\n#container #header {\n  position: fixed;\n  z-index: 6;\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  width: calc(100% - 15%);\n  padding: 20px 7.5%;\n  color: #fff;\n  transition: all 0.2s ease-out;\n}\n#container #header.colored {\n  background-color: rgba(255, 255, 255, 0.98);\n  box-shadow: 0 3px 8px rgba(0, 0, 0, 0.2);\n}\n#container #header.colored #logo span {\n  color: #2c2c2e;\n}\n#container #header.colored #links #links-list .links-list-item a {\n  color: #333436;\n}\n#container #header.colored #social .social-link.vk .image {\n  background-image: url('images/social/dark/vk.png') !important;\n}\n#container #header.colored #social .social-link.fb .image {\n  background-image: url('images/social/dark/facebook.png') !important;\n}\n#container #header.colored #social .social-link.be .image {\n  background-image: url('images/social/dark/behance.png') !important;\n}\n#container #header #logo {\n  position: relative;\n  width: 33%;\n  display: inline-block;\n  text-align: left;\n}\n#container #header #logo img {\n  width: 35px;\n  height: 35px;\n}\n#container #header #logo span {\n  position: absolute;\n  top: 50%;\n  transform: translateY(-50%);\n  margin-left: 10px;\n  font-weight: bold;\n}\n#container #header #links {\n  width: 33%;\n  display: inline-block;\n}\n#container #header #links #links-list {\n  margin: 0;\n  padding: 0;\n  list-style: none;\n  text-align: center;\n}\n#container #header #links #links-list .links-list-item {\n  display: inline-block;\n}\n#container #header #links #links-list .links-list-item:not(:first-child) {\n  margin-left: 18px;\n}\n#container #header #links #links-list .links-list-item a {\n  color: #fff;\n  text-transform: uppercase;\n  font-size: 14px;\n  font-weight: bold;\n}\n#container #header #social {\n  text-align: right;\n  width: 33%;\n  display: inline-block;\n}\n#container #hero {\n  z-index: 4;\n  height: 750px;\n  overflow: hidden;\n}\n#container #hero #hero-fader {\n  position: absolute;\n  width: 100%;\n  height: 100%;\n  z-index: 2;\n  background-color: rgba(0, 0, 0, 0.4);\n}\n#container #hero .content {\n  position: absolute;\n  z-index: 2;\n  width: 500px;\n  top: 45%;\n}\n#container #hero .content #hero-text {\n  position: relative;\n  font-size: 70px;\n  font-weight: bold;\n  color: #fff;\n}\n#container #hero .content #hero-text .text-container {\n  position: relative;\n  width: 100%;\n  height: 100%;\n  z-index: 1;\n}\n#container #hero .content #hero-text::after {\n  position: absolute;\n  content: '';\n  bottom: -10px;\n  left: 0;\n  width: 80%;\n  height: 20px;\n  background: url('images/hero-bottom-line.png') no-repeat;\n  background-size: 100%;\n  left: 50%;\n  transform: translateX(-50%);\n}\n#container #hero .content #purchase {\n  margin-top: 40px;\n  transition: all 0.2s ease-out;\n}\n#container .heading {\n  color: #333436;\n}\n#container #about-white-rect {\n  z-index: 5;\n  height: 200px;\n}\n#container #about-white-rect #about {\n  position: absolute;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  width: 70%;\n  height: 300px;\n  transform: translateY(-50%);\n  left: 15%;\n  border-radius: 10px;\n  background-color: #0060E3;\n  color: #fff;\n  box-shadow: 0px 30px 60px -30px rgba(0, 0, 0, 0.45);\n}\n#container #about-white-rect #about #text-about {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  flex-grow: 3;\n  font-size: 14px;\n  letter-spacing: 4px;\n  font-weight: bold;\n  text-transform: uppercase;\n}\n#container #about-white-rect #about #about-description {\n  display: flex;\n  flex-direction: row;\n  flex-grow: 4;\n  padding-top: 5px;\n}\n#container #about-white-rect #about #about-description #left {\n  width: 48%;\n  font-size: 48px;\n  font-weight: bold;\n  letter-spacing: -1px;\n  text-align: right;\n  margin-right: 15px;\n}\n#container #about-white-rect #about #about-description #right {\n  font-family: 'Times New Roman', sans-serif;\n  padding-top: 5px;\n  margin-left: 15px;\n  width: 40%;\n  height: 50%;\n  padding-bottom: 30px;\n  font-size: 28px;\n  border-bottom: 1px solid rgba(255, 255, 255, 0.4);\n}\n#container #directions {\n  height: 630px;\n  background-color: #1B1D1F;\n}\n#container #directions #directions-wrapper {\n  position: absolute;\n  width: 60%;\n  top: 70px;\n  left: 20%;\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: center;\n}\n#container #directions #directions-wrapper .direction {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  text-align: center;\n}\n#container #directions #directions-wrapper .direction .image {\n  width: 55px;\n  height: 55px;\n}\n#container #directions #directions-wrapper .direction .description {\n  margin-top: 15px;\n  color: #fff;\n  font-weight: bold;\n  font-size: 12px;\n  letter-spacing: 2px;\n  text-transform: uppercase;\n}\n#container #works {\n  height: 600px;\n  background-color: #F7F7F7;\n}\n#container #works #works-rectangle {\n  position: absolute;\n  top: -400px;\n  left: 25%;\n  width: 50%;\n  height: 800px;\n  background-color: #0060E3;\n  border-radius: 10px;\n  box-shadow: 0px 30px 60px -30px rgba(0, 0, 0, 0.45);\n}\n#container #works #works-rectangle #works-rect-title {\n  width: 100%;\n  line-height: 100px;\n  text-align: center;\n  font-size: 14px;\n  letter-spacing: 4px;\n  font-weight: bold;\n  text-transform: uppercase;\n  color: #fff;\n}\n#container #works #works-wrapper {\n  position: absolute;\n  top: -300px;\n  width: 100%;\n  height: 590px;\n  background-color: transparent;\n}\n#container #works #works-wrapper .slick-arrow {\n  display: none !important;\n}\n#container #works #works-wrapper .slick-track {\n  height: 615px;\n}\n#container #works #works-wrapper .slick-track .slick-slide {\n  overflow: hidden;\n  width: 500px !important;\n  height: 590px !important;\n  margin-left: 40px !important;\n  background-color: #e6e6e6;\n  border-radius: 3px;\n  box-shadow: 0px 5px 15px rgba(0, 0, 0, 0.25) !important;\n}\n#container #works #works-wrapper .slick-track .slick-slide:not(:first-child) {\n  margin-left: 0;\n}\n#container #works #works-wrapper .slick-track .slick-slide .work {\n  height: 590px;\n  background-size: cover;\n}\n#container #works #works-wrapper .slick-track .slick-slide:last-child {\n  display: none;\n}\n#container #works #works-wrapper .slick-dots {\n  bottom: -55px !important;\n}\n#container #works #works-wrapper .slick-dots li button {\n  transition: all 0.2s ease-out;\n}\n#container #works #works-wrapper .slick-dots li:hover button::before {\n  color: rgba(255, 255, 255, 0.8);\n}\n#container #works #works-wrapper .slick-dots li.slick-active button::before {\n  font-size: 10px;\n  color: #fff;\n}\n#container #works #btn-portfolio {\n  position: absolute;\n  bottom: 80px;\n  left: 50%;\n  transform: translateX(-50%);\n  transition: all 0.2s ease-out;\n}\n#container #clients-and-reviews {\n  height: 600px;\n  background-color: #fff;\n}\n#container #clients-and-reviews #reviews-title {\n  width: 100%;\n  line-height: 100px;\n  text-align: center;\n  font-size: 14px;\n  letter-spacing: 4px;\n  font-weight: bold;\n  text-transform: uppercase;\n  color: #333436;\n}\n#container #clients-and-reviews #reviews {\n  position: absolute;\n  width: 60%;\n  margin-top: 70px;\n  left: 20%;\n}\n#container #clients-and-reviews #reviews .slick-track .slick-arrow {\n  display: none !important;\n}\n#container #clients-and-reviews #reviews .slick-track .slick-slide {\n  width: 250px;\n  height: 320px;\n}\n#container #clients-and-reviews #reviews .slick-track .slick-slide:not(:first-child) {\n  margin-left: 45px;\n}\n#container #clients-and-reviews #reviews .slick-track .slick-slide .date {\n  width: 100%;\n  text-align: center;\n  font-family: 'Times New Roman', sans-serif;\n  color: #333436;\n  font-size: 14px;\n}\n#container #clients-and-reviews #reviews .slick-track .slick-slide .title {\n  width: 100%;\n  text-align: center;\n  margin-top: 10px;\n  color: #333436;\n  font-size: 24px;\n  font-weight: bold;\n}\n#container #clients-and-reviews #reviews .slick-track .slick-slide .content {\n  width: 100%;\n  text-align: center;\n  margin-top: 10px;\n  font-family: 'Times New Roman', sans-serif;\n  font-size: 20px;\n  color: #828282;\n}\n#container #clients-and-reviews #clients {\n  position: absolute;\n  width: 60%;\n  bottom: 20px;\n  left: 20%;\n  margin-bottom: 30px;\n}\n#container #clients-and-reviews #clients .slick-slide img {\n  width: 100%;\n}\n#container #clients-and-reviews #clients .client:not(:first-child) {\n  margin-left: 80px;\n}\n#container #contact-us {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  height: 550px;\n  background-color: #1B1D1F;\n}\n#container #contact-us #contact-stripe {\n  width: 100%;\n  height: 15px;\n  background-color: #0060E3;\n}\n#container #contact-us #contact-us-title {\n  margin-top: 50px;\n  text-transform: uppercase;\n  width: 100%;\n  text-align: center;\n  font-size: 14px;\n  letter-spacing: 4px;\n  font-weight: bold;\n  color: #0060E3;\n}\n#container #contact-us #contact-us-form {\n  margin-top: 70px;\n  width: 540px;\n}\n#container #contact-us #contact-us-form form {\n  width: 100%;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n#container #contact-us #contact-us-form form #form-title {\n  font-size: 30px;\n  font-weight: bold;\n  color: #fff;\n}\n#container #contact-us #contact-us-form form #form-description {\n  margin-top: 10px;\n  font-family: 'Times New Roman';\n  text-align: center;\n  font-size: 22px;\n  color: #969696;\n}\n#container #contact-us #contact-us-form form #form-fields-holder {\n  margin-top: 15px;\n  display: flex;\n  flex-direction: row;\n  width: 100%;\n}\n#container #contact-us #contact-us-form form #form-fields-holder #form-left,\n#container #contact-us #contact-us-form form #form-fields-holder #form-right {\n  width: 50%;\n  flex-grow: 1;\n  display: flex;\n  flex-direction: column;\n}\n#container #contact-us #contact-us-form form #form-fields-holder #form-left input,\n#container #contact-us #contact-us-form form #form-fields-holder #form-right input {\n  font-family: 'Times New Roman', sans-serif;\n  font-size: 18px;\n  padding: 14px 12px;\n  width: calc(100% - 24px);\n  background-color: #fff;\n  color: #828282;\n  border: none;\n  border-radius: 2px;\n}\n#container #contact-us #contact-us-form form #form-fields-holder #form-left input:last-child,\n#container #contact-us #contact-us-form form #form-fields-holder #form-right input:last-child {\n  margin-top: 15px;\n}\n#container #contact-us #contact-us-form form #form-fields-holder #form-right {\n  margin-left: 15px;\n}\n#container #contact-us #contact-us-form form button {\n  margin-top: 20px;\n  transition: all 0.2s ease-out;\n}\n#container #footer {\n  display: flex;\n  flex-direction: row;\n  justify-content: center;\n  align-items: center;\n  height: 180px;\n  background-color: #141416;\n}\n#container #footer #footer-social-links {\n  margin: 0;\n  padding: 0;\n}\n", ""]);
