...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var scrollToLinks = Array.from(document.querySelectorAll('.scroll-to'));

    scrollToLinks.forEach(function (link) {
        link.addEventListener('click', function () {
            (0, _scrollToElement2.default)('#' + link.getAttribute('data-scroll-to'), {
                offset: 0
            });
        });
    });
    ...
    (0, _jquery2.default)('#reviews').slick({
        slidesToShow: 3
    });
