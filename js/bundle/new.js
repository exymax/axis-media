...
var iterateNodeCollection = function iterateNodeCollection(collection, callback) {
    [].forEach.call(collection, function (item) {
        callback(item);
    });
};

var hideActiveElements = function hideActiveElements(elements) {
    iterateNodeCollection(elements, function (element) {
...
var pageAnimationsLoadPromise = new Promise(function (resolve, reject) {
    (0, _lodash.forEach)(animationMap, function (animation) {
        delayClassToggle(animation.selector, animation.delay);
    });
    var maxDelayAnimation = (0, _lodash.maxBy)(animationMap, function (animation) {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var directionPages = document.querySelectorAll('.page');
    var activeDirectionPage = null;
    var activeDirectionName = null;
    var directionPageCloseButtons = document.querySelectorAll('.page .head .close-direction');
    ...
    iterateNodeCollection(directions, function (direction) {
        direction.addEventListener('mousedown', function (e) {
            ...
            setTimeout(function () {
                ...
                var directionPage = document.querySelector(directionSelector);
    ...
    iterateNodeCollection(directionPageCloseButtons, function (directionCloseButton) {
        directionCloseButton.addEventListener('mousedown', function () {
